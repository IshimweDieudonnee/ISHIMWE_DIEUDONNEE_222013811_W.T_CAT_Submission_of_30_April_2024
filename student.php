<?php
    ...
    $sel = mysqli_query($con, "SELECT * FROM students WHERE stid=$id ");
    ...
    if (isset($_POST['sub'])) {
      ...
      $update = mysqli_query($con, "UPDATE students SET firstname='$firstname', lastname='$lastname', dob='$dob', phone='$phone', address='$address', regno='$regno', class='$class' WHERE stid=$id");
      if ($update) {
        header("location:students.php");
      }
    }
    if (isset($_GET['del'])) {
      mysqli_query($con, "DELETE from students WHERE stid=$id");
      header("location:students.php");
    }
 ?>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview mt-3" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['regno'];?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      <label for="regno" class="col-md-4 col-lg-3 col-form-label">Reg No</label>
                      <div class="col-md-8 col-lg-9">
                        <input required name="regno" type="text" class="form-control" id="regno" value="<?php echo $row['regno'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input required name="class" type="text" class="form-control" id="class" value="<?php echo $row['class'];?>">
                      </div>
                    </div>
