<?php
    ...
    if (isset($_POST['send'])) {
      ...
      $insert = mysqli_query($con, "INSERT INTO students VALUES(null,'$regno','$firstname','$lastname','$dob','$phone','$address','$class')");
      if ($insert) {
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate method="post">
                <div class="col-md-12">
                  <label for="regno" class="form-label">Student RegNo</label>
                  <input type="text" class="form-control" id="regno" name="regno" required>
                  <div class="invalid-feedback">Please write a Reg number.</div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control" id="inputAddres5s" name="dob" required>
                ...
                <div class="col-md-6">
                  ...
                  <div class="invalid-feedback">Please choose a correct class.</div>
                </div>
